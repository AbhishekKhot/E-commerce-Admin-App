...
import com.example.codeboomvendorapp.databinding.ProductItemBinding
...
class ProductAdapter(val context: Context,):RecyclerView.Adapter<ProductAdapter.ProductViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        Glide.with(holder.itemView).load(product.product_cover_image).placeholder(R.drawable.ic_image_search).into(holder.binding.ivProduct)
            ...
            btnDelete.setOnClickListener {
                ...
                alert.setTitle("DELETE")
                    ...
                    .setPositiveButton("YES") { dialog, which ->
                        ...
                        fireStore.collection("Products").whereEqualTo("product_id",product.product_id).get()
